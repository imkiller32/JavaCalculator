...
class calculator extends JFrame implements ActionListener
{
	...
	public calculator()
	{
		...
		bg.add(d1);
		bg.add(o);
		obj.add(a);obj.add(b);obj.add(c);obj.add(d);obj.add(e);obj.add(f);
		obj.add(i1);obj.add(h1);obj.add(g1);obj.add(f1);obj.add(e1);obj.add(d1);obj.add(c1);obj.add(b1);obj.add(g);obj.add(h);obj.add(i);obj.add		(j);obj.add
